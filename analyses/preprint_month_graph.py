...
plt.axhline(y=2400, xmin=0, xmax=len(x1), linewidth=2, color = 'k',linestyle=':',zorder=-1)
plt.axhline(y=2600, xmin=0, xmax=len(x1), linewidth=2, color = 'k',linestyle=':',zorder=-1)
...
plt.savefig('november_preprints.png')
